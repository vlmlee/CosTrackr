...
import ProjectSummary from '../imports/ui/components/ProjectSummary.js';
...
FlowRouter.route('/project-test', {
	name: 'test',
	action() {
		mount(AppContainer, {
			main: (props) => (<ProjectSummary project={props.projects[0]} /> ),
		});
	}
});
...
FlowRouter.route('/profile', {
	...
	action() {
		mount(AppContainer, {
			...
			section: (props) => (<ListOfProjects {...props} pageId="section"/>),
		});
	},
});
